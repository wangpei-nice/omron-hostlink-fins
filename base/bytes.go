...
// WriteUint64 编码
func WriteUint64ToBytes(buf []byte, value uint64) {
	buf[0] = byte(value >> 56)
	buf[1] = byte(value >> 48)
	buf[2] = byte(value >> 40)
	buf[3] = byte(value >> 32)
...
func WriteUint64LittleEndianToBytes(buf []byte, value uint64) {
	buf[7] = byte(value >> 56)
	buf[6] = byte(value >> 48)
	buf[5] = byte(value >> 40)
	buf[4] = byte(value >> 32)
...
// WriteUint32 编码
func WriteUint32ToBytes(buf []byte, value uint32) {
	buf[0] = byte(value >> 24)
	buf[1] = byte(value >> 16)
	buf[2] = byte(value >> 8)
	buf[3] = byte(value)
...
func WriteUint32LittleEndianToBytes(buf []byte, value uint32) {
	buf[3] = byte(value >> 24)
	buf[2] = byte(value >> 16)
	buf[1] = byte(value >> 8)
	buf[0] = byte(value)
...
// WriteUint24 编码
func WriteUint24ToBytes(buf []byte, value uint32) {
	buf[0] = byte(value >> 16)
	buf[1] = byte(value >> 8)
	buf[2] = byte(value)
}
...
func WriteUint24LittleEndianToBytes(buf []byte, value uint32) {
	buf[2] = byte(value >> 16)
	buf[1] = byte(value >> 8)
	buf[0] = byte(value)
}
...
// WriteUint16 编码
func WriteUint16ToBytes(buf []byte, value uint16) {
	buf[0] = byte(value >> 8)
	buf[1] = byte(value)
}

// WriteUint16LittleEndian 编码
func WriteUint16LittleEndianToBytes(buf []byte, value uint16) {
	buf[1] = byte(value >> 8)
	buf[0] = byte(value)
}

// WriteFloat32 编码
func WriteFloat32ToBytes(buf []byte, value float32) {
	val := math.Float32bits(value)
	WriteUint32ToBytes(buf, val)
}

// WriteFloat32LittleEndian 编码
func WriteFloat32LittleEndianToBytes(buf []byte, value float32) {
	val := math.Float32bits(value)
	WriteUint32LittleEndianToBytes(buf, val)
}

// WriteFloat64 编码
func WriteFloat64ToBytes(buf []byte, value float64) {
	val := math.Float64bits(value)
	WriteUint64ToBytes(buf, val)
}

// WriteFloat64LittleEndian 编码
func WriteFloat64LittleEndianToBytes(buf []byte, value float64) {
	val := math.Float64bits(value)
	WriteUint64LittleEndianToBytes(buf, val)
}
